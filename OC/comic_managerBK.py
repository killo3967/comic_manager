...
class frameMain ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.edit_new_panel = wx.Menu()
        self.menu_main_edit_new_panel_directories = wx.MenuItem( self.edit_new_panel, wx.ID_ANY, u"Directory", wx.EmptyString, wx.ITEM_NORMAL )
        self.edit_new_panel.Append( self.menu_main_edit_new_panel_directories )

        self.menu_main_edit_new_panel_viewers = wx.MenuItem( self.edit_new_panel, wx.ID_ANY, u"Viewers", wx.EmptyString, wx.ITEM_NORMAL )
        self.edit_new_panel.Append( self.menu_main_edit_new_panel_viewers )

        self.menu_main_edit_new_panel_library = wx.MenuItem( self.edit_new_panel, wx.ID_ANY, u"Library", wx.EmptyString, wx.ITEM_NORMAL )
        self.edit_new_panel.Append( self.menu_main_edit_new_panel_library )

        self.menu_main_edit_new_panel_shelf = wx.MenuItem( self.edit_new_panel, wx.ID_ANY, u"Shelf", wx.EmptyString, wx.ITEM_NORMAL )
        self.edit_new_panel.Append( self.menu_main_edit_new_panel_shelf )

        self.menu_main_edit_new_panel_pages = wx.MenuItem( self.edit_new_panel, wx.ID_ANY, u"Pages", wx.EmptyString, wx.ITEM_NORMAL )
        self.edit_new_panel.Append( self.menu_main_edit_new_panel_pages )

        self.menu_main_edit_new_panel_comicviewer = wx.MenuItem( self.edit_new_panel, wx.ID_ANY, u"Comic Viewer", wx.EmptyString, wx.ITEM_NORMAL )
        self.edit_new_panel.Append( self.menu_main_edit_new_panel_comicviewer )

        self.menu_main_edit_new_panel_metadata = wx.MenuItem( self.edit_new_panel, wx.ID_ANY, u"Metadata", wx.EmptyString, wx.ITEM_NORMAL )
        self.edit_new_panel.Append( self.menu_main_edit_new_panel_metadata )

        self.menu_Main_Edit.AppendSubMenu( self.edit_new_panel, u"New Panel" )
        ...
        self.menu1 = wx.Menu()
        self.menu_main_configuration_addprofile = wx.MenuItem( self.menu1, wx.ID_ANY, u"Add Profile", wx.EmptyString, wx.ITEM_NORMAL )
        self.menu1.Append( self.menu_main_configuration_addprofile )

        self.menu_main_configuration_delprofile = wx.MenuItem( self.menu1, wx.ID_ANY, u"Delete Profife", wx.EmptyString, wx.ITEM_NORMAL )
        self.menu1.Append( self.menu_main_configuration_delprofile )

        self.menu_main_configuration_cloneprofile = wx.MenuItem( self.menu1, wx.ID_ANY, u"Clone Profile", wx.EmptyString, wx.ITEM_NORMAL )
        self.menu1.Append( self.menu_main_configuration_cloneprofile )

        self.menuMain_Configuration.AppendSubMenu( self.menu1, u"Mange Profiles" )
        ...
        self.tool2 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool3 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool4 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool5 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
        ...
        self.tool14 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool15 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool16 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool17 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool18 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.auiToolBar_Main.AddSeparator()

        self.tool181 = self.auiToolBar_Main.AddTool( wx.ID_ANY, u"tool", wx.Bitmap( u"icons/exit_16.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
        ...
        self.genericDirCtrl1 = wx.GenericDirCtrl( self.auinotebook_main_panel_directories, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.DIRCTRL_3D_INTERNAL|wx.SUNKEN_BORDER, wx.EmptyString, 0 )

        self.genericDirCtrl1.ShowHidden( False )
        bSizer5.Add( self.genericDirCtrl1, 1, wx.EXPAND |wx.ALL, 5 )
        ...
        self.grid_pages = wx.grid.Grid( self.auinotebook_main_panel_pages, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )

        # Grid
        self.grid_pages.CreateGrid( 5, 5 )
        self.grid_pages.EnableEditing( True )
        self.grid_pages.EnableGridLines( True )
        self.grid_pages.EnableDragGridSize( False )
        self.grid_pages.SetMargins( 0, 0 )

        # Columns
        self.grid_pages.EnableDragColMove( False )
        self.grid_pages.EnableDragColSize( True )
        self.grid_pages.SetColLabelAlignment( wx.ALIGN_CENTER, wx.ALIGN_CENTER )

        # Rows
        self.grid_pages.EnableDragRowSize( True )
        self.grid_pages.SetRowLabelAlignment( wx.ALIGN_CENTER, wx.ALIGN_CENTER )

        # Label Appearance

        # Cell Defaults
        self.grid_pages.SetDefaultCellAlignment( wx.ALIGN_LEFT, wx.ALIGN_TOP )
        bSizer8.Add( self.grid_pages, 0, wx.ALL|wx.EXPAND, 5 )
        ...
        self.checkBox1 = wx.CheckBox( self.auinotebook_main_panel_Log, wx.ID_ANY, u"Error", wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer9.Add( self.checkBox1, 0, wx.ALL, 5 )

        self.checkBox111 = wx.CheckBox( self.auinotebook_main_panel_Log, wx.ID_ANY, u"Warning", wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer9.Add( self.checkBox111, 0, wx.ALL, 5 )

        self.checkBox1111 = wx.CheckBox( self.auinotebook_main_panel_Log, wx.ID_ANY, u"Notice", wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer9.Add( self.checkBox1111, 0, wx.ALL, 5 )

        self.checkBox11111 = wx.CheckBox( self.auinotebook_main_panel_Log, wx.ID_ANY, u"Info", wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer9.Add( self.checkBox11111, 0, wx.ALL, 5 )

        self.checkBox111111 = wx.CheckBox( self.auinotebook_main_panel_Log, wx.ID_ANY, u"Debug", wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer9.Add( self.checkBox111111, 0, wx.ALL, 5 )


        bSizer9.Add( ( 0, 0), 1, wx.EXPAND, 5 )

        self.staticText1 = wx.StaticText( self.auinotebook_main_panel_Log, wx.ID_ANY, u"Filter:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.staticText1.Wrap( -1 )

        bSizer9.Add( self.staticText1, 0, wx.ALL, 5 )

        self.textCtrl1 = wx.TextCtrl( self.auinotebook_main_panel_Log, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer9.Add( self.textCtrl1, 0, wx.ALL, 5 )
        ...
        # self.Bind( wx.EVT_MENU, self.main_menu_exit, id = self.menu_main_file_exit.GetId() )
